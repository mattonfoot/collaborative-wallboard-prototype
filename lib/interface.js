...
Interface.prototype.newBoard = function( wallid ) {
  if ( this.displayBoardCreator( wallid ) ) {
    this._queue.publish( 'boardcreator.displayed', wallid );
  }
};
...
Interface.prototype.newPocket = function( wallid ) {
  if ( this.displayPocketCreator( wallid ) ) {
    this._queue.publish( 'pocketcreator.displayed', wallid );
  }
};
...
Interface.prototype.newRegion = function( boardid ) {
  if ( this.displayRegionCreator( boardid ) ) {
    this._queue.publish( 'regioncreator.displayed', boardid );
  }
};

      ...
      .then(function( data ) {
          ...
          db.update( 'region', id, update )
              .then(function( region ) {
                  ...
                  io.sockets.emit( 'region:moved', region );
...
app.router.post('/regions/:id/resize', function(req, res) {
    ...
    .then(function( data ) {
      ...
      db.update( 'region', id, update )
          .then(function( region ) {
              ...
              io.sockets.emit( 'region:resized', region );
    ...
    return {
        ...
        create: function( data ) {
            ...
            return db.create( 'region', obj )
                .then(  created,
                        function( err ) {
                            io.sockets.emit( 'region:createfail', {
                                data: data,
                                err: err
                            });
                        }
        ...
        update: function( data ) {
            ...
            return db.update( 'region', regionid, data )
                .then(  updated,
                        function( err ) {
                            io.sockets.emit( 'region:updatefail', {
                                data: data,
                                err: err
                            });
                        }
        ...
        delete: function( id ) {
            return db.delete( 'region', id )
                .then(  deleted,
                        function( err ) {
                            io.sockets.emit( 'region:deletefail', {
                                id: id,
                                err: err
                            });
                        }
    ...
    function created( region ) {
        io.sockets.emit( 'region:created', region );
    }

    function updated( region ) {
        io.sockets.emit( 'region:updated', region );
    }

    function deleted( region ) {
        io.sockets.emit( 'region:deleted', region );
    }

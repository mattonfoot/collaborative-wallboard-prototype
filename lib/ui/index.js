...
function UI( q, $element, options, $ ) {
    ...
    // failure logger
    queue.subscribe('#.fail', function( err ) { console.log( err ); });
...
function trackNewRegionEvents( $body, ui ) {
  $body
    ...
    .on( 'newRegionRequest',                                newRegion.bind( ui ) );
}
...
function getClientXCoordinate( e ) { return getClientCoordinate( c, 'X' ); }
function getClientYCoordinate( e ) { return getClientCoordinate( c, 'Y' ); }

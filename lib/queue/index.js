...
var PouchEventStore = require('./pouch.eventstore')( postal );
var SocketIOWireTap = require('./socketio.wiretap')( postal );
...
function EventQueue( options ) {
  ...
  if ( options.federate && this.clientId ) {
    this.federation = new SocketIOWireTap( this.channel, this.clientId );
  }

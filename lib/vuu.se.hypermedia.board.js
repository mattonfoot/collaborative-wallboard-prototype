...
function init( app, io ) {
    ...
    return {
        ...
        create: function( data ) {
            ...
            return db.create( 'board', obj )
                .then(  created,
                        function( err ) {
                            io.sockets.emit( 'board:createfail', {
                                data: data,
                                err: err
                            });
                        }
        ...
        update: function( data ) {
            ...
            return db.update( 'board', boardid, data )
                .then(  updated,
                        function( err ) {
                            io.sockets.emit( 'board:updatefail', {
                                data: data,
                                err: err
                            });
                        }
        ...
        delete: function( id ) {
            return db.delete( 'board', id )
                .then(  deleted,
                        function( err ) {
                            io.sockets.emit( 'board:deletefail', {
                                id: id,
                                err: err
                            });
                        }
    ...
    function created( board ) {
        io.sockets.emit( 'board:created', board );
    }

    function updated( board ) {
        io.sockets.emit( 'board:updated', board );
    }

    function deleted( board ) {
        io.sockets.emit( 'board:deleted', board );
    }

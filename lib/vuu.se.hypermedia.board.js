...
function init( app ) {
      ...
      app.hypermedia.board
          ...
          .then(function( resource ) {
              ...
              fs.readFile(__dirname + '/templates/boards/edit.mustache', function (error, data) {
                  ...
                  if ( (board.links.transforms || []).length == 0) {
    ...
    app.resource('board', resource )
        .transform('board', function( request, response ) {
            ...
            if (board.transform) {
                app.hypermedia.transform
                    .create({ board: id, phrase: board.transform });
            }
            ...
            .then(function( wall ) {
                wall.links.pockets
                    .forEach(function( pocket ) {
                        app.hypermedia.card.create( { pocket: pocket, board: board.id } );
                    });
            });
    }

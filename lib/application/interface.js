...
Interface.prototype.attachInterfaceEvents = function attachInterfaceEvents() {
  ...
  addUIListener( 'wall.select',     this.prototype.displayWallSelector );
  addUIListener( 'wall.create',     this.prototype.createWall );
  addUIListener( 'wall.display',    this.prototype.displayWall );
  addUIListener( 'wall.edit',       this.prototype.editWall );
  addUIListener( 'wall.update',     this.prototype.updateWall );

  addUIListener( 'view.new',        this.prototype.newView );
  addUIListener( 'view.create',     this.prototype.createView );
  addUIListener( 'view.display',    this.prototype.displayView );
  addUIListener( 'view.edit',       this.prototype.editView );
  addUIListener( 'view.update',     this.prototype.updateView );
  addQueueSubscription( 'view.added',   this.prototype.postCreateView );

  addUIListener( 'region.new',      this.prototype.newRegion );
  addUIListener( 'region.create',   this.prototype.createRegion );
  addUIListener( 'region.display',  this.prototype.displayRegion );
  addUIListener( 'region.edit',     this.prototype.editRegion );
  addUIListener( 'region.update',   this.prototype.updateRegion );
  addQueueSubscription( 'region.added', this.prototype.postCreateRegion );

  addUIListener( 'card.new',          this.prototype.newCard );
  addUIListener( 'card.create',       this.prototype.createCard );
  addUIListener( 'card.display',      this.prototype.displayCard );
  addUIListener( 'card.edit',         this.prototype.editCard );
  addUIListener( 'card.update',       this.prototype.updateCard );
  addQueueSubscription( 'card.added',   this.prototype.postCreateCard );

  addUIListener( 'transform.new',     this.prototype.newTransform );
  addUIListener( 'transform.create',  this.prototype.createTransform );
  addUIListener( 'transform.edit',    this.prototype.editTransform );
  addUIListener( 'transform.update',  this.prototype.updateTransform );

  addUIListener( 'login.auth',        this.prototype.authLogin );
};

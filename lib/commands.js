...
function Commands( adapter, queue ) {
    ...
    models.forEach(function( model ) {
      ...
      db.on( model + ':updated', function( doc ) {
          queue.publish( model + ':updated', doc );
        })
        .on( model + ':deleted', function( doc ) {
...
models.forEach(function( model ) {
  ...
  Commands.prototype[ command + model ] = function( data ) {
    ...
    return new Promise(function( resolve, reject ) {
      ...
      db[ command ]( schema, data ).catch( reject ); // --> model:commanded ( board:created, pocket:updated )
...
models.forEach(function( model ) {
  ...
  Commands.prototype[ command + model ] = function( data ) {
    ...
    return new Promise(function( resolve, reject ) {
      ...
      db[ command ]( schema, data ).then( resolve, reject ); // --> model:commanded ( board:created, pocket:updated )

      queue.publish( model + ':updated', data );
    });
  };
});

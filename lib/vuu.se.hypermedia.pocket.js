  ...
  app.resource('pocket', resource )
      .transform('pocket', function( request, response ) {
          ...
          if (request.method.toLowerCase() === 'post') {
              pocket.createdBy = request.user._json.user_id;
              pocket.createdOn = new Date();
          }

          if (request.method.toLowerCase() === 'put') {
              pocket.lastModifiedBy = request.user._json.user_id;
              pocket.lastModifiedOn = new Date();
          }
  ...
  return {
      ...
      create: function( data ) {
          ...
          return db.create( 'pocket', obj )
              .then(  created,
                      function( err ) {
                          console.trace( 'pocket:createfail', err, data );
      ...
      update: function( data ) {
          ...
          return db.update( 'pocket', pocketid, data )
              .then(  updated,
                      function( err ) {
                          console.trace( 'pocket:updatefail', err, data );
      ...
      delete: function( id ) {
          return db.delete( 'pocket', id )
              .then(  deleted,
                      function( err ) {
                          console.trace( 'pocket:deletefail', err, data );
